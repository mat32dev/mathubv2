      ...
      <div className="container mx-auto px-6 py-12 max-w-7xl">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <aside className="lg:col-span-4 space-y-12">
            ...
            <div className="bg-mat-800 border-2 border-mat-700 p-10 rounded-[3rem] shadow-2xl relative overflow-hidden">
               <div className="absolute top-0 left-0 w-full h-1 bg-mat-500"></div>
               <div className="flex items-center justify-between mb-10">
                  <div className="flex items-center gap-3 text-mat-500 font-black text-[10px] uppercase tracking-widest">
                     <TrendingUp size={18} /> TRENDING HUB
                  </div>
                  <div className="bg-green-500/10 text-green-500 px-3 py-1 rounded-full text-[8px] font-black uppercase flex items-center gap-1">
                     <div className="w-1 h-1 bg-green-500 rounded-full animate-pulse"></div> LIVE
                  </div>
               </div>
               ...
               <div className="space-y-6">
                  {['#italodisco', '#rarevinyls', '#ruzafasessions', '#hifiaddicts'].map((tag, i) => (
                    <div key={i} className="flex items-center justify-between group cursor-pointer">
                       <span className="text-white font-black uppercase text-sm tracking-tight group-hover:text-mat-500 transition-colors">{tag}</span>
                       <span className="text-gray-600 text-[10px] font-bold">+{12 + i*5} posts</span>
                    </div>
                  ))}
               </div>
               
               <div className="mt-12 pt-8 border-t border-mat-700/50">
                  <div className="flex items-center gap-4 mb-6">
                     <div className="flex -space-x-4">
                        {[1,2,3,4].map(i => (
                          <div key={i} className="w-10 h-10 rounded-full border-2 border-mat-800 bg-mat-900 overflow-hidden">
                             <img src={`https://i.pravatar.cc/100?u=user${i}`} className="w-full h-full object-cover" />
                          </div>
                        ))}
                     </div>
                     <span className="text-gray-500 text-[10px] font-black uppercase tracking-widest">42 ACTIVE NOW</span>
                  </div>
               </div>
            </div>

            {/* Shop Integration */}
            <div className="bg-mat-900 border-2 border-mat-500/20 p-10 rounded-[3rem] shadow-2xl group/shop">
               <div className="flex items-center gap-3 text-mat-500 font-black text-[10px] uppercase tracking-widest mb-8">
                  <ShoppingBag size={18} /> LATEST ARRIVALS
               </div>
               <div className="space-y-8">
                  <div className="flex gap-4">
                     <div className="w-16 h-16 bg-black rounded-2xl overflow-hidden shadow-xl">
                        <img src="https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?q=80&w=200" className="w-full h-full object-cover grayscale group-hover/shop:grayscale-0 transition-all" />
                     </div>
                     <div className="flex-1">
                        <p className="text-white font-black uppercase text-xs truncate">Disco Hits Vol.1</p>
                        <p className="text-mat-500 text-[9px] font-black uppercase tracking-widest">€25.00</p>
                     </div>
                  </div>
                  <Link to="/records" className="w-full py-4 bg-mat-800 text-gray-400 hover:text-white font-black uppercase text-[10px] tracking-widest rounded-2xl border border-mat-700 flex items-center justify-center gap-2 transition-all">
            ...
            {/* VIP Access Promo */}
            <div className="bg-mat-500 p-10 rounded-[3rem] shadow-[0_20px_60px_rgba(234,88,12,0.3)] text-white group overflow-hidden relative">
               <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:rotate-12 transition-transform duration-1000">
                  <Disc size={200} />
               </div>
               <div className="relative z-10">
                  <h4 className="text-3xl font-black uppercase tracking-tighter font-exo mb-4 leading-none">Mat32<br/>Elite Access.</h4>
                  <p className="text-white/70 text-sm italic mb-8 leading-relaxed">Join our inner circle for rare record drops and priority booth slots.</p>
                  <button className="w-full py-5 bg-white text-mat-900 font-black uppercase tracking-widest rounded-2xl shadow-xl hover:-translate-y-1 transition-all">DISCOVER ELITE</button>
               </div>
            </div>
